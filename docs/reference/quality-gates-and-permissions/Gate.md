...
[Permissions and writes](Permissions-and-writes.md) uses for write
...
([Permissions and writes](Permissions-and-writes.md)) is not: the write
...
- [Permissions and writes](Permissions-and-writes.md) — the companion
  enforcement mechanism for *what an agent may write*, as opposed to *what it
  claims it did*.
- [Rule zero](Rule-zero.md) — why gates must be wired and
